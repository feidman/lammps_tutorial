...
For more info on calculating diffusion coefficients, see Secionn 8.3.7
(Howto diffusion) of the LAMMPS manual and the examples/DIFFUSE dir.

For more info on calculating liquid viscosiy, see Secionn 8.3.6 (Howto
...
% eom image.25000.jpg                # view final snapshot
